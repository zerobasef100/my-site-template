...
export function Contact() {
  ...
  const defaultInfo = {
    ...
    experience: "3년 경력",
    phone: "010-8631-2582",
    email: "swagcon12@naver.com",
    website: "",
    location: "서울시 관악구 / 직장:가산",
    ...
    bottomSubMessage: "성공적인 프로젝트를 위해 최선을 다하겠습니다.",
    qrContent: ["name","phone","email"],
    profileEmoji: "👤",
  ...
  const defaultSocialLinks: { name: string; icon: string; url: string }[] = [
    {
      "name": "계정",
      "icon": "instagram",
      "url": "https://www.instagram.com/jn_woo000?igsh=MTgzMjFoZWJxZ2ow"
    },
    {
      "name": "취미",
      "icon": "instagram",
      "url": "https://www.instagram.com/wu.climb?igsh=MWpqcDRhZTZmMG92YQ=="
    },
    {
      "name": "이메일",
      "icon": "mail",
      "url": "swagcon12@naver.com"
    }
  ]
